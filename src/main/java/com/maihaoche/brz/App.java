...
import com.maihaoche.brz.command.Contract;
...
//    private static DownloadFile findOrder(String accessToken, DownloadContractCommand downloadContractCommand) throws IOException {
//        String notifyUrl = String.format("%s/v1/contract", Config.DOMAIN);
//        return HTTP_CLIENT.(notifyUrl, downloadContractCommand, accessToken);
//    }
}
