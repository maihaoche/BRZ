...
public class App {
    ...
    public static void main(String[] args) {
        try {
            ...
            //例子2、放款通知卖好车
            notify(accessToken.getToken(), new SendMessageCommand(UUID.randomUUID().toString(), "lent", Collections.<Long>emptyList()));

            //例子3、还款通知卖好车
            notify(accessToken.getToken(), new SendMessageCommand(UUID.randomUUID().toString(), "repaid", Collections.<Long>emptyList()));
